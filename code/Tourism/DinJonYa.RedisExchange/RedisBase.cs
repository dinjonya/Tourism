/// <summary> 
///     作者：
///     时间：2016/9/21 17:19:47  
///     部门：  
///     公司：Axon
///     版权：2016-2012  
///  CLR版本：4.0.30319.42000 
///     说明：本代码版权归Axon所有
/// 唯一标识：5d59fd4a-bb17-4566-af5b-ba8edf5b4299 
///
/// 更改作者：
/// 更改说明：
/// </summary>
...
namespace DinJonYa.RedisExchange
{
    public class RedisBase : IRedisClient
    {
        ...
        private static Lazy<ConnectionMultiplexer> lazyConnection = new Lazy<ConnectionMultiplexer>(() =>
        {
            ...
            foreach (RedisIP_Config ipConfig in redisConfig.RedisIps)
            {
        ...
        public bool Cleardb()
        {
            foreach (RedisIP_Config ip in redisConfig.RedisIps)
            {
        ...
        public List<T> StringGetList<T>(string host, int port, string key, int pageSize = 1000, CommandFlags commandFlags = CommandFlags.None)
            where T : class
        {
            var _db = _redis.GetDatabase();
            try
