...
namespace DinJonYa.Plugs.Http
{
    ...
    public class HttpUtil
    {
        ...
        {
            return Post(url, postdata, "application/x-www-form-urlencoded", "Mozilla-Firefox-Spider(Axon)");
        }
        ...
        public static string Post(string url, IDictionary<string, object> parameters)
        {
            ...
            return Post(url, data, "application/x-www-form-urlencoded", "Mozilla-Firefox-Spider(Axon)");
        }
        ...
        {
            return Post(url, postdata, "text/xml", "Mozilla-Firefox-Spider(Axon)");
        }
